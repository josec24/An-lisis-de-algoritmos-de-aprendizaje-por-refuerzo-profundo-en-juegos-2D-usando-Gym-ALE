...
from models.duelingDQN import DuelingDQN
from buffer.experienceBuffer import ExperienceBuffer
from agents.duelingDQN_agent import Agent
        ...
        for step in range(MAX_STEPS):
            ...
            if reward is not None:
                ...
                if score>record:
                    ...
                    torch.save(net.state_dict(), './learnedModels/'+NAME+'_duelingdqn_model.pt')
                    torch.save(target_net.state_dict(), './learnedModels/'+NAME+'_duelingdqn_target_model.pt')
                else:
